...
@section('content')
<div class="community-title-area bg-1" style="background:url({{ asset('public/assets/images/communities') }}/{{ $community->banner }}) no-repeat center; background-size:cover;">
        <div class="container">
            <div class="page-title-content">
                ...
                <ul>
                    ...
                    <li class="active">{{$community->slug}}</li>
                </ul>
            </div>
        </div>
    </div>
