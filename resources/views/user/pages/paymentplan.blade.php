               ...
               <div class="row no-gutters proj-bro">
                  ...
                  <div class="col-lg-6 mycontact">
                     <div class="card location rounded-0">
                        <div class="card-body">
                           <h3><span><i class="fa fa-download mr-1" aria-hidden="true"></i>Download Payment Plan</span></h3>
                           <div class="form-group mybrochure">
                              ...
                              <a href="{{route('floor.plan',$project->slug)}}"  class="brochbtn "><i class="fa fa-object-group" aria-hidden="true"></i>Floor Plan </a>
                              <a href="{{route('payment.plan',$project->slug)}}"  class="brochbtn active"><i class="fa fa-money" aria-hidden="true"></i>Payment Plan </a>
                           </div>
                           ...
                           <div class="form-group">
                                ...
                                <input name="phone" type="text" maxlength="13" id="txtphonepbr phone" class="form-control" placeholder="Contact No *" onkeypress="if((event.keyCode < 48 || event.keyCode > 57) &amp;&amp; (event.keyCode < 43 || event.keyCode > 45)) event.returnValue=false;" onkeydown="fnchkbtnbroch();" onblur="fnchkbtnbroch();" onkeyup="fnchkbtnbroch();">
                           </div>
                          <button type="button" class="btn btn-dark d-block paymentplanbtn">Download Now</button>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
   $(document).ready(function(){
    $('.paymentplanbtn').attr('disabled',true);
     
     
    $('.email').keyup(function(){
        if($(this).val().length !=0){
            $('.paymentplanbtn').attr('disabled', false);
        }
        else
        {
            $('.paymentplanbtn').attr('disabled', true);        
   ...
   $(document).on('click','.paymentplanbtn',function(){
       ...
       $.ajax({
           ...
           success:function(resp)
           {
               if(resp.success == true)
               {
                   ...
                   window.location.href="@if($details){{asset('public/assets/images/projects/documents')}}/{{$details->paymentplan}}@endif";
               }
           },
           error:function(resp)
           {
