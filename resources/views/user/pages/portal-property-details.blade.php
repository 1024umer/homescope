...
<head>
    ...
    <meta name="tags" content="{{$property['title'] }} ">
    <meta name="description" content="{{ $property['description'] }} ">
    <meta name="keywords" content="{{$property['title'] }} ">
...
<body style="background:#3E3C3D">
    <div id="mySidenav" class="sidenav" style="width: 250px; right: -35px;">
        ...
        <span> <a rel="nofollow"
                                href="https://api.whatsapp.com/send?l=en&amp;phone=+971509260992&amp;text=I want more information on {{$property['title'] }}"
    ...
    <div id="main">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-4 col-md-6 col-lg-6 menu-left">
                        <div class="call-btn">
                            <a href="tel:+971526892790">
                                <img src="{{ asset('public/assets/images/call.png') }}" width="15" height="15"
                                    alt="Call Us">
                                <span>+971 52 689 2790</span></a>
                            <a rel="nofollow"
                                href="https://api.whatsapp.com/send?l=en&amp;phone=+971526892790&amp;text=I want more information on {{$property['title'] }}"
                                target="_blank" class="mr-3">
                                <img src="{{ asset('public/assets/images/whats-app.svg') }}" width="15"
                                    height="15" alt="WhatsApp">
                                <span>+971 52 689 2790</span>
                            </a>
                        </div>
                    </div>
            ...
            <div id='proslider' class='carousel slide' data-ride='carousel'>
                <div class='carousel-inner'>
                    <div class='carousel-item active'>
                        <img class='d-block' src="{{$property['banner']}}" width='1400'
                            height='600' alt='{{$property['title'] }}'>
                        ...
                        <div class="col-md-12 col-lg-9 order-md-1" itemprop="offers" itemscope
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div id="divPathMenu" class="breadcrumb"><a class='breadcrumb-item'
                                            ...
                                            Home</a><span class='breadcrumb-item'>{{$property['title'] }}</span><span
                                            class='breadcrumb-item active'>Overview</span></div>
                                </div>
                                <div class="col-md-4">
                                    <!--<div class="download">-->
                                    <!--    <a href="" class="brochuremodalbtn">Download-->
                                    <!--        Brochure</a>-->
                                    <!--</div>-->
                                </div>
                            </div>
                            <div id="divSummary" class="card pro_head mb-4">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <h2 class="titles"><span itemprop="name">{{$property['title'] }}</span>
                                                
                                            </h2>
                                            <h3 class="location">By <strong></strong>&nbsp; | &nbsp; <a
                                                    title="Sobha Hartland"
                                                    href="javascript:;">
                                                    <i class="fa fa-map-marker"></i>&nbsp; {{$property['community']}}</a>
                                            </h3>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="price-head">
                                                <a>
                                                    ...
                                                    <h2 id="lblStartingPrice" itemprop="price"><span
                                                            id="lblPriceId">AED {{$property['price']}}</span>&nbsp;<i id="pricehsid"
                                            ...
                                            <table class="table summmry">
                                                <tbody id="SummarId">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>@if($property['property_type'] == 'TH') Townhouse @elseif($property['property_type'] == 'VH') Villa @elseif( $property['property_type'] == 'AP') Apartment @endif</td>
                                                    </tr>
                                                   
                                                  
                                                    <tr>
                                                        <th><i class='fa fa-bed'></i>Bedrooms: </th>
                                                        <td><a href="javascript:;">{{$property['bedrooms']}}</a>
                                                        </td>
                                                    </tr>
                                                   <tr>
                                                        <th><i class='fa fa-bath'></i>Bathrooms: </th>
                                                        <td><a href="javascript:;">{{$property['bathrooms']}}</a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$property['size']}} Sq.ft <i class='fa fa-info-circle'
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="divImageGallery" class="row banner_sec lightgallery">
                                        <div class='col-md-8'><a
                                                href='{{$property['banner']}}'><img
                                                    src='{{$property['banner']}}'
                                                    width='900' height='600'
                                                    data-echo='{{$property['banner']}}'
                                                    alt='' class='img-fluid cover'></a></div>
                                        <div class='col-md-4'>
                                            @php
                                                $photos = Count($property['photos']['url']);
                                            @endphp
                                            @foreach($property['photos']['url'] as $photo)
                                            <div class='banner_holder'> <a
                                                    href='{{ $photo}}'> <img
                                                        src='{{ $photo}}'
                                                        width='900' height='600'
                                                        data-echo='{{ $photo}}'
                                                        alt='{{$property['title']}}' class='img-fluid cover'><span class="more-img-count"></span></a> </div>
                                                        @endforeach
                    ...
                    <div class="col-lg-12">
                        <div class=" text-center">
                            <p class="text-white mb-0 copyright">
                                &copy; 2023 <a href="/" style="color:white"> {{$property['title']}} </a> All
                                Rights Reserved.
                            </p>
                        </div>
                    </div>
        ...
        <div class="call-pont">
            <ul>
                ...
                <li><a rel="nofollow"
                        href="https://api.whatsapp.com/send?l=en&amp;phone= +971 52 295 3747&amp;text=I want more information on {{$property['title']}} ">
