                     ...
                     <div class="card location rounded-0">
                        <div class="card-body">
                           ...
                           <div class="form-group mybrochure">
                              <a href="{{route('brochure',$project->slug)}}"  class="brochbtn active"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>Project Brochure</a>
                           ...
                           <button type="button" class="btn btn-dark d-block brochurebtn">Download Now</button>
                        </div>
                     </div>
                  </div>
               </div>
...
<script>
   $(document).ready(function(){
    $('.brochurebtn').attr('disabled',true);
     
     
    $('.email').keyup(function(){
        if($(this).val().length !=0){
            $('.brochurebtn').attr('disabled', false);
        }
        else
        {
            $('.brochurebtn').attr('disabled', true);        
       ...
       $.ajax({
           ...
           success:function(resp)
           {
               if(resp.success == true)
               {
                   ...
                   window.location.href="@if($details){{asset('public/assets/images/projects/documents')}}/{{$details->brochure}}@endif";
               }
           },
           error:function(resp)
           {
