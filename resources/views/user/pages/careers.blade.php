...
<html lang="en" class="no-js">
  <head>
   ...
   <link rel="stylesheet" href="{{asset('public/career-assets/css/bootstrap.min.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('public/career-assets/css/normalize.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('public/career-assets/css/animate.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('public/career-assets/css/transition-animations.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('public/career-assets/css/owl.carousel.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('public/career-assets/css/magnific-popup.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('public/career-assets/css/main-green.css')}}" type="text/css">

<!-- This styles needs for demo -->
<link rel="stylesheet" href="{{asset('public/career-assets/css/lmpixels-demo-panel.css')}}" type="text/css">
<!-- /This styles needs for demo -->

<script src="{{asset('public/career-assets/js/jquery-2.1.3.min.js')}}"></script>
<script src="{{asset('public/career-assets/js/modernizr.custom.js')}}"></script>
  </head>
    ...
    <div class="header-content">
      ...
      <div class="site-nav">
        ...
        <ul id="nav" class="site-main-menu">
          ...
          <li>
            <a class="pt-trigger" href="#careers">Careers</a><!-- href value = data-id without # of .pt-page. -->
          </li>
          {{-- <li>
          ...
          <div class="page-header">
            <div class="row">
              <div class="col-sm-4 col-md-4 col-lg-4">
                <div class="">
                 <img src="@if($generalsettings){{ asset('public/assets/images/logo') }}/{{ $generalsettings->logo }}@endif" class="main-logo" alt=" Properties">
                </div>
              </div>
              ...
              <div class="col-sm-8 col-md-8 col-lg-8">
                <div class="title-block">
                  ...
                  <div class="owl-carousel text-rotation">                                    
                    <div class="item">
                      <div class="sp-subtitle">We’re hiring Join us at Homescope now for an amazing work culture "TOWARDS GROWING FUTURE"</div>
                    </div>
                    {{-- <div class="item">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6">
                <div class="about-me">
                  ...
                  <p>Homescope Real Estate Company is a leading and reputable property development firm based in Dubai, United Arab Emirates. With a strong focus on quality, innovation, and customer satisfaction, Homescope has established itself as a trusted name in the real estate industry.</p>
                </div>
                <div class="block-title">
                    <h3>Job <span>Description</span></h3>
                </div>
                <ul class="info-list">
                  <li><span class="title">Job Type: </span><span class="value">Full-time</span></li>
                  
                  <li><span class="title">Job Timings: </span><span class="value">9 am - 6 pm Monday –  Saturday (Sundays are off)</span></li>
              ...
              <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <ul class="info-list">
                <li><span class="title">1- Sales negotiation, communication, and client relationship skills</span></li>
                <li><span class="title">2- Presentable with a professional image</span></li>
                <li><span class="title">3- Financially stable to work on commission basis</span></li>
                <li><span class="title">4- Content Creation (upto 2 videos a day)</span></li>
                <li><span class="title">5- Generating leads from content and following up with them</span></li>
                <li><span class="title">6- Scheduling meetings and site visits with potential clients.</span></li>
                <li><span class="title">7- Advise clients on market conditions, prices, and mortgage solutions</span></li>
                ...
                <ul class="info-list">
                  <li><span class="title">1- The employee will be entitled to 30 days of annual vacation plus all UAE national holidays as per UAE labour law.</span></li>
                  <li><span class="title">2- Brand Building</span></li>
                  <li><span class="title">3- Employment visa provided by the company</span></li>
                  ...
                  <li><span class="title">7- Assistance with RERA training course</span></li>
          ...
          <div class="page-content">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12">
                ...
                <form id="" method="post" action="{{route('application')}}" enctype="multipart/form-data">
                   @csrf
                  ...
                  <div class="controls">
                    ...
                    <div class="form-group form-group-with-icon">
                        <i class="fa fa-user"></i>
                        <label>Email</label>
                        <input id="form_name" type="email" name="email" class="form-control" placeholder="Email Address" >
                        <div class="form-control-border"></div>
                        <div class="help-block with-errors"></div>
                    </div>  
                    <div class="form-group form-group-with-icon">
                      ...
                      <input id="form_name" type="text" name="driving_license" class="form-control" placeholder=" Driving License" >
                      <div class="form-control-border"></div>
                      <div class="help-block with-errors"></div>
                    </div>
                    ...
                    <div class="form-group form-group-with-icon">
                      <i class="fa fa-car"></i>
                      <label>Car</label>
                      <input id="form_email" type="text" name="car" class="form-control" placeholder=" Car" >
                      <div class="form-control-border"></div>
                      <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group form-group-with-icon">
                        ...
                        <input id="form_email" type="text" name="experience_in_dubai" class="form-control" placeholder="Experience in Dubai" >
                        <div class="form-control-border"></div>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group form-group-with-icon">
                        ...
                        <input id="form_email" type="text" name="visa_status" class="form-control" placeholder="Visa Status" >
                        <div class="form-control-border"></div>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group form-group-with-icon">
                        ...
                        <input id="form_email" type="text" name="visa_validity" class="form-control" placeholder="Visa Validity" >
                        <div class="form-control-border"></div>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group form-group-with-icon">
                        ...
                        <input id="form_email" type="text" name="nationality" class="form-control" placeholder="Nationality" >
                        <div class="form-control-border"></div>
                        <div class="help-block with-errors"></div>
                      </div>
                      <div class="form-group form-group-with-icon">
                        ...
                        <input id="form_email" type="file" name="resume" class="form-control" placeholder="" >
                        <div class="form-control-border"></div>
                        <div class="help-block with-errors"></div>
                      </div>
...
<script type="text/javascript" src="{{asset('public/career-assets/js/pages-switcher.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/imagesloaded.pkgd.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/validator.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/jquery.shuffle.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/masonry.pkgd.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/owl.carousel.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/jquery.magnific-popup.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/jquery.hoverdir.js')}}"></script>
...
<script type="text/javascript" src="{{asset('public/career-assets/js/jquery.googlemap.js')}}"></script>
<script type="text/javascript" src="{{asset('public/career-assets/js/main.js')}}"></script>
 <!-- Demo Color changer Script -->
 <script src="{{asset('public/career-assets/js/lmpixels-demo-panel.js')}}"></script>
 <!-- /Demo Color changer Script -->
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v2cb3a2ab87c5498db5ce7e6608cf55231689030342039" integrity="sha512-DI3rPuZDcpH/mSGyN22erN5QFnhl760f50/te7FTIYxodEF8jJnSFnfnmG/c+osmIQemvUrnBtxnMpNdzvx1/g==" data-cf-beacon='{"rayId":"7e85a9bedb9d895c","version":"2023.4.0","r":1,"token":"94b99c0576dc45bf9d669fb5e9256829","si":100}' crossorigin="anonymous"></script>
