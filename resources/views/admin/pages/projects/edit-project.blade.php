    ...
    <div class="col-xl-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <hr>
          {!! Form::model($project, ['method' => 'PATCH','route' => ['projects.update', $project->id] , 'enctype'=> 'multipart/form-data','class' => 'row g-3']) !!}
          <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" name="price" value="{{ old('price') ?? $project->price}}">
          @if ($errors->has('price'))
        ...
        <div class="col-6">
            ...
            <select name="developer_id" class="form-control">
              <option value="{{old('developer_id') ?? $project->developer_id}}">{{$project->developer}}</option>
        ...
        <div class="col-6">
            ...
            <select name="community_id" class="form-control">
              <option value="{{old('community_id') ?? $project->community_id}}">{{$project->community}}</option>
       ...
       <div class="col-4">
                            ...
                            <select name="category" class="form-control">
                                 <option value="{{old('category') ?? $project->category}}">{{$project->category}}</option>
        ...
        <div class="col-4">
            ...
            <select name="property_type" class="form-control">
              <option value="{{old('property_type') ?? $project->property_type}}">{{$project->property_type}}</option>
        ...
        <div class="col-4">
            ...
            <select name="property_sub_type" class="form-control">
              <option value="{{old('property_sub_type') ?? $project->property_sub_type}}">{{$project->property_sub_type}}</option>
        ...
        <div class="col-6">
            ...
            <select name="unit_type" class="form-control">
              <option value="{{old('unit_type') ?? $project->unit_type}}">{{$project->unit_type}}</option>
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="plot_size" value="{{ old('plot_size') ?? $project->plot_size}}">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="built_up_area"
                value="{{ old('built_up_area') ?? $project->built_up_area}}">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="handover" value="{{ old('handover') ?? $project->handover}}">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="payment_plan"
                value="{{ old('payment_plan') ?? $project->payment_plan}}">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="down_payment"
                value="{{ old('down_payment') ?? $project->down_payment}}">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="during_construction"
                value="@if($details){{ old('during_construction')  ??  $details->during_construction }} @endif">
            
        </div>
        <div class="col-6">
            <label class="form-label">At Handover Payment</label>
            <input type="text" class="form-control" name="handover_payment"
                value="@if($details){{ old('handover_payment')  ??  $details->handover_payment }}@endif">
        </div>
        <div class="col-12">
            ...
            @if($details)
            @php
                $projectamenities = explode(',',$details->amenities);
            @endphp
            @endif
            
            <div class="form-check">
                <input class="form-check-input" type="checkbox" name="amenities[]" id="{{$row->name}}" value="{{$row->id}}" @if($details) @foreach($projectamenities as $amenity) {{($row->id == $amenity)? 'checked':''}} @endforeach @endif>
                <label class="form-check-label" for="{{$row->name}}">{{$row->name}}</label>
            </div>
            
            @endforeach
        </div>
        <input type="hidden" name="amenity_id" value="@if($details){{$details->id}}@endif">
        <div class="col-6">
        ...
        <div class="col-6">
            ...
            <input type="text" class="form-control" name="meta_tags" value="{{ old('meta_tags') ?? $project->meta_tags}}">
        ...
        <div class="col-12">
            ...
            <textarea class="form-control" name="features_description"> @if($details) {{ old('features_description') ?? $details->features_details}} @endif</textarea>

        </div>
          <div class="col-12">
                            <label class="form-label"> Location Description</label>
                            <textarea class="form-control" name="location_description"> @if($details) {{ old('location_description') ?? $details->location_details}} @endif</textarea>

                        </div>
        <div class="col-12">
            <label class="form-label"> Master Plan Description</label>
            <textarea class="form-control" name="master_description"> @if($details) {{ old('master_description') ?? $details->master_details}} @endif</textarea>

        </div>
        <div class="col-12">
            <label class="form-label"> Description</label>
            <textarea class="ckeditor"  name="description"> {{ old('description') ?? $project->description }}</textarea>
            @if ($errors->has('down_payment'))
                <span class="text-danger">{{ $errors->first('down_payment') }}</span>
            @endif
        </div>
