    ...
    <div class="col-xl-8 mx-auto">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h6 class="mb-0 text-uppercase">Edit Amenity</h6>
          <hr>
          {!! Form::model($amenity, ['method' => 'PATCH','route' => ['amenities.update', $amenity->id] , 'enctype'=> 'multipart/form-data','class' => 'row g-3']) !!}
            <div class="col-12">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control" name="description"> {{ old('description') ?? $amenity->description}}</textarea>
