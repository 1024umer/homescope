                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto pl-5 pr-5">
                                ...
                                <form action="{{route('user.validate.login')}}" method="post">
                                    @csrf
                                    ...
                                    <div class="text-center pt-3">
                                        Don’t have an account? <a class="font-weight-bold" href="{{route('user.register')}}">Sign
                                            Up</a>
                                    </div>
                                </form>
                                <hr class="my-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col pl-2">
                                        <a href="{{ route('facebook.login') }}" class="btn pl-1 pr-1 btn-lg btn-facebook font-weight-normal text-white btn-block text-uppercase"
